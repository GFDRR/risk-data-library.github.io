    ...
    $.get(url, function (data) {
      ...
      function render(dataset, schema) {
        ...
        return (
          ...
          "<span class='table-dialog-text' id='" + schema + dataset.id + "'><a href='" + dataset.download_link + "' download target='_blank' class='table-dialog-download-link reusable-font-regular'>Download CSV</a></span>" +
          "<span class='table-dialog-text'><a href='#' download target='_blank' class='table-dialog-download-link reusable-font-regular'>Download type B</a></span>" +
      ...
      $(document).click(function(event) {
        ...
        if (!$(target).is('td.data-table-image') && !$(target).parents().is('td.data-table-image')) {
          $('td.data-table-image>div>span').removeClass('show');
        }
      });
